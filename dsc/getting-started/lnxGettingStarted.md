...
Bu konuda, Linux için PowerShell Desired State Configuration (DSC) ile çalışmaya başlamak açıklanmaktadır. DSC hakkında genel bilgi için bkz: [Windows PowerShell Desired State Configuration ile'çalışmaya başlama](../overview/overview.md).
...
Sürüm 1.0.8.1 Open Management Infrastructure (OMI) CIM sunucusu Linux gerektirir Desired State Configuration veya üzeri. OMI açık grubundan indirilebilir: [Açık Yönetim Altyapısı (OMI)](https://github.com/Microsoft/omi).
