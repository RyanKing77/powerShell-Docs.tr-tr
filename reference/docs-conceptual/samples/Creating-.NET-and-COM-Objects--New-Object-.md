...
#### <a name="storing-objects-in-variables"></a><span data-ttu-id="b7b3a-123">Değişkenleri nesneler depolanıyor</span><span class="sxs-lookup"><span data-stu-id="b7b3a-123">Storing Objects in Variables</span></span>
