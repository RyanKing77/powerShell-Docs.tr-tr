...
|----------|----------------------|----------|
|**Yardım**|F1|Betik bölmesinde **önemli:** F1 Yardımı Web'de TechNet Kitaplığı'ndan gelen veya (bkz. Update-Help) Yardım indirilen belirtebilirsiniz. Seçmek için tıklatın **Araçları**, **seçenekleri**, sonra da **genel ayarları**sekmesinde, ayarlama veya kaldırma **yerel Yardım içeriği yerine çevrimiçi içerik kullanın.**|
|**Kopyalama**|CTRL+C|Betik bölmesinde, komut bölmesi, çıkış bölmesi|
|**Kes**|CTRL + X|Betik bölmesi, komut bölmesi|
|**Genişlet veya daralt anahat oluşturma**|CTRL+M|Komut dosyası bölmesi|
...
|**Eşleşen Ayraç Bul**|CTRL +]|Komut dosyası bölmesi|
|**Yapıştır**|CTRL+V|Betik bölmesi, komut bölmesi|
|**Yinele**|CTRL + Y|Betik bölmesi, komut bölmesi|
|**Komut dosyasında değiştirin**|CTRL + H|Komut dosyası bölmesi|
|**Kaydet**|CTRL+S|Komut dosyası bölmesi|
|**Tümünü Seç**|CTRL+A|Betik bölmesinde, komut bölmesi, çıkış bölmesi|
|**Parçacıkları Göster**|CTRL+J|Betik bölmesi, komut bölmesi|
|**Geri alma**|CTRL + Z|Betik bölmesi, komut bölmesi|
...
|**Sekme** (için sonraki komut dosyası)|CTRL + SEKME **Not:** sonraki komut dosyası sekmesine çalışır yalnızca açın, tek bir Windows PowerShell sekme sahip veya ne zaman, birden fazla Windows PowerShell sekmesini açmak varsa, ancak betik bölmesinde odak noktasıdır.|
|**Sekme** (için önceki komut dosyası)|CTRL + SHIFT + SEKME **Not:** önceki betik sekmesine çalışır, tek bir Windows PowerShell sekme açık olduğunda ya da birden fazla Windows PowerShell sekmesini açmak varsa ve betik bölmesinde odak noktasıdır.|
...
|Eylem|Klavye kısayolu|
|----------|---------------------|
|**Komut (v2) veya Konsolu gidin (v3 ve sonraki sürümler) bölmesi**|CTRL + D|
|**(Yalnızca v2) çıkış bölmesine gidin**|CTRL + SHIFT + O|
...
|**Liste kesme noktaları**|CTRL + SHIFT + M|Betik bölmesinde, bir komut dosyası hata ayıklaması|
...
> [!NOTE]
> İçin Windows PowerShell Konsolu komut dosyalarında Windows PowerShell ISE ayıklarken tasarlanmış klavye kısayollarını da kullanabilirsiniz. Bu kısayolları kullanmak için komut bölmesinde kısayol yazın ve ENTER tuşuna basın.
...
|**Önceki PowerShell sekmesi**|CTRL + SHIFT + SEKME. Hiçbir dosya herhangi bir Windows PowerShell sekmede açık olduğunda bu kısayol çalışır.|
|**Sonraki Windows PowerShell sekmesi**|CTRL + SEKME. Hiçbir dosya herhangi bir Windows PowerShell sekmede açık olduğunda bu kısayol çalışır.|
...
- [PowerShell dergisi: Tam listesini Windows PowerShell ISE klavye kısayolları](http://www.powershellmagazine.com/2013/01/29/the-complete-list-of-powershell-ise-3-0-keyboard-shortcuts/)
