...
ms.locfileid: "55686974"
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="b67fb-102">PowerShell Betiği bulma, yükleme ve Yönetimi ile PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="b67fb-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="b67fb-103">PowerShell Betiği paylaşımı özelliğini PowerShellGet WMF 5.0 RTM sürümünde eklenen.</span><span class="sxs-lookup"><span data-stu-id="b67fb-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="b67fb-104">PowerShellGet modülü, PowerShell betikleri desteklemek için aşağıdaki yeni cmdlet eklendi.</span><span class="sxs-lookup"><span data-stu-id="b67fb-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="b67fb-105">Betik cmdlet'lerini paylaşımı sözdizimi:</span><span class="sxs-lookup"><span data-stu-id="b67fb-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
