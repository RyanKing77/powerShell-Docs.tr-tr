...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="e6b3b-102">PowerShell komut dosyası bulma, yükleme ve Yönetimi PowerShellGet ile</span><span class="sxs-lookup"><span data-stu-id="e6b3b-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="e6b3b-103">PowerShell komut dosyası paylaşımı özelliğini PowerShellGet WMF 5.0 RTM sürümünde eklenen.</span><span class="sxs-lookup"><span data-stu-id="e6b3b-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="e6b3b-104">Aşağıdaki yeni cmdlet'leri PowerShell komut dosyalarını desteklemek için PowerShellGet modülü eklenir.</span><span class="sxs-lookup"><span data-stu-id="e6b3b-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="e6b3b-105">Cmdlet'leri paylaşımı komut sözdizimi:</span><span class="sxs-lookup"><span data-stu-id="e6b3b-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
