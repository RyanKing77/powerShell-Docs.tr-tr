...
ms.locfileid: "62057390"
---
# <a name="installation-of-module-dependencies"></a><span data-ttu-id="d45f4-102">Modül Bağımlılıklarının Yüklenmesi</span><span class="sxs-lookup"><span data-stu-id="d45f4-102">Installation of Module Dependencies</span></span>

<span data-ttu-id="d45f4-103">Install-Module, yan yana (SxS) modülü sürüm desteği sunuldu güncelleştirme modülü ve Windows PowerShell 5.0 veya daha yeni çalışması Publish-Module cmdlet'leri.</span><span class="sxs-lookup"><span data-stu-id="d45f4-103">There is now side-by-side (SxS) module version support in Install-Module, Update-Module, and Publish-Module cmdlets that run in Windows PowerShell 5.0 or newer.</span></span>
<span data-ttu-id="d45f4-104">Yayımlanacak sürümü belirtmek için Publish-Module cmdlet'e - RequiredVersion parametresi de ekledik.</span><span class="sxs-lookup"><span data-stu-id="d45f4-104">Also, we have added a -RequiredVersion parameter to the Publish-Module cmdlet to specify the version to be published.</span></span> <span data-ttu-id="d45f4-105">Path parametresi artık sürüm klasörle modül temel yolu destekler.</span><span class="sxs-lookup"><span data-stu-id="d45f4-105">The Path parameter now supports the module base path with the version folder.</span></span>

<span data-ttu-id="d45f4-106">**Install-Module örnekler:**</span><span class="sxs-lookup"><span data-stu-id="d45f4-106">**Install-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="d45f4-107">**Bir modül bağımlılıkları ile yükleyin:**</span><span class="sxs-lookup"><span data-stu-id="d45f4-107">**Install a module with dependencies:**</span></span>
```powershell
PS C:\windows\system32> Get-InstalledModule
...
<span data-ttu-id="d45f4-108">**Bildirim dosyası ModuleWithDependencies2 modül içeriği:**</span><span class="sxs-lookup"><span data-stu-id="d45f4-108">**Contents of ModuleWithDependencies2 module manifest file:**</span></span>
```powershell
@{
...
<span data-ttu-id="d45f4-109">**Update-Module örnekler:**</span><span class="sxs-lookup"><span data-stu-id="d45f4-109">**Update-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="d45f4-110">**Yayımlama-Module örnekler:**</span><span class="sxs-lookup"><span data-stu-id="d45f4-110">**Publish-Module examples:**</span></span>
```powershell
