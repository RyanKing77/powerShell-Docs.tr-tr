...
---
# <a name="installation-of-module-dependencies"></a>Modül Bağımlılıklarının Yüklenmesi
...
**Bir modül bağımlılıkları ile yükleyin:**
```powershell
PS C:\\windows\\system32&gt; Get-InstalledModule
...
**ModuleWithDependencies2 modülü içeriğini bildirim dosyası:**
```powershell
@{
...
**Güncelleştirme modülü örnekler:**
```powershell
