...
---
# <a name="runspace04--vbnet-code-sample"></a>RunSpace04 (VB.NET) Kod Örneği

VB.NET kaynak kodu Runspace04 örneği aşağıda verilmiştir. Bu örnekte [System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke) bir sonlandırma hatası oluşturur bir betik yürütmek için sınıf. Hata yakalama ve hata kaydı yorumlama konak uygulama sorumludur.

> [!NOTE]
> Bu örnek için Microsoft .NET Framework 3.0 çalışma zamanı bileşenleri ve Windows Vista için Windows yazılım geliştirme Seti'ni kullanarak VB.NET kaynak dosyası (runspace02.vb) indirebilirsiniz. Yükleme yönergeleri için bkz: [Windows PowerShell yükleme ve indirme Windows PowerShell SDK'sı](/powershell/developer/installing-the-windows-powershell-sdk).
>
