...
ms.locfileid: "56845069"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="a8a0c-102">GetProc05 (VB.NET) Örnek Kod</span><span class="sxs-lookup"><span data-stu-id="a8a0c-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="a8a0c-103">Burada, GetProc05 örnek cmdlet için tam VB.NET kodu verilmiştir.</span><span class="sxs-lookup"><span data-stu-id="a8a0c-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="a8a0c-104">Ayrıca bkz:</span><span class="sxs-lookup"><span data-stu-id="a8a0c-104">See Also</span></span>

[<span data-ttu-id="a8a0c-105">Windows PowerShell SDK'sı</span><span class="sxs-lookup"><span data-stu-id="a8a0c-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)