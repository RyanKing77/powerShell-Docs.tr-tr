...
---
# <a name="getprocesssample05-sample"></a>GetProcessSample05 Örneği

Bu örnek, Get-Proc cmdlet tam bir sürümünü gösterir.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Visual Studio kullanarak örneği oluşturmak nasıl.

1. Windows Gezgini'ni açın ve örnekler dizini altında GetProcessSample05 dizinine gidin.

   Windows PowerShell 2.0 yüklü SDK ile GetProcessSample05 klasöre gidin. C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05 varsayılan konumdur.
...
3. İçinde **derleme** menüsünde **Çözümü Derle**.
   ...
   Kitaplık için örneği varsayılan \bin veya \bin\debug'dır dizinlerde oluşturulur.
...
- Parametreler için konumları belirtme.

- Parametre ardışık düzen tarafından giriş alabilir belirtme. Giriş bir nesne veya bir parametre adı ile aynı özellik adı olan bir nesnenin bir özellik değerinden alınabilir.

- Giriş parametresi için bir doğrulama özniteliği bildirme.

- Hataları ve özel durumları işleme.

- Hata ayıklama iletiler.

## <a name="example"></a>Örnek

Bu örnek, belirli işlemlerin bir listesini görüntüleyen bir cmdlet oluşturma işlemi gösterilmektedir.
