...
---
# <a name="host06-sample"></a>Host06 Örneği

Bu örnek, komut satırından komutları okur, komutları yürütür ve sonuçları konsola görüntüler etkileşimli konsol tabanlı konak uygulamanın nasıl oluşturulacağını gösterir. Ayrıca, bu örnek, kullanıcı tarafından girilen metin rengi belirtmek için belirteç Oluşturucu API kullanır.

## <a name="requirements"></a>Gereksinimler

- Bu örnek, Windows PowerShell 2.0 gerektirir.

- Bu uygulama, yükseltilmiş modda (yönetici olarak çalıştır) çalıştırmanız gerekir.

## <a name="demonstrates"></a>Gösteriler

- Bu sınıflar türetilen özel bir ana bilgisayar oluşturma [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) sınıfı [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) sınıfı ve [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) sınıfı.

- Bir konsol uygulaması oluşturma, etkileşimli bir Windows PowerShell Kabuk oluşturmak için bu konak sınıfları kullanır.

- Oluşturma bir `$profile` değişkeni ve Profiller yükleniyor.

  - Geçerli kullanıcı, geçerli konak
...
- Uygulama [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) arabirimi.

- Uygulama [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) kullanarak etkileşimli uzaktan iletişimini desteklemek için arabirimi [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) ve [ Çıkış-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet'leri.

- Simgeleştirin yazıldığı gibi komut satırı renklendirmek için API'yi kullanın.

## <a name="example"></a>Örnek

 Bu örnek komutlar bir komut satırında girmesini sağlar, bu komutları işleyen ve ardından sonuçları yazdırır.
...
## <a name="example"></a>Örnek
 ...
 Aşağıdaki kod uygulamasıdır [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) bu konak uygulama tarafından kullanılan sınıf. Uygulanmaz bu öğeleri bir özel durum veya hiçbir şey döndürmeyen.
...
## <a name="example"></a>Örnek
 ...
 Aşağıdaki kod uygulamasıdır [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) bu konak uygulama tarafından kullanılan sınıf.
...
## <a name="example"></a>Örnek
 ...
 Aşağıdaki kod uygulamasıdır [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) bu konak uygulama tarafından kullanılan sınıf. Uygulanmaz bu öğeleri bir özel durum veya hiçbir şey döndürmeyen.
...
## <a name="example"></a>Örnek
 ...
 Girildiği gibi aşağıdaki kod komut satırı ve renkleri metin okur. Belirteçleri kullanarak belirlenir [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) yöntemi.
