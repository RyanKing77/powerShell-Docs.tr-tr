...
---
# <a name="role-based-authorization-configuration-schema"></a>Rol Tabanlı Yetkilendirmeyi Yapılandırma Şeması

[PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) örnek yetkilendirme ilkesini yapılandırma XML dosyası kullanır. Bu dosyalar için kullanılan şema, aşağıdaki XSD tanımlar.
