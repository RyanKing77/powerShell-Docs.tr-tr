---
title: Rol tabanlı yetkilendirme yapılandırma şeması | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62080552"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="18511-102">Rol Tabanlı Yetkilendirmeyi Yapılandırma Şeması</span><span class="sxs-lookup"><span data-stu-id="18511-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="18511-103">[PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) örnek yetkilendirme ilkesini yapılandırma XML dosyası kullanır.</span><span class="sxs-lookup"><span data-stu-id="18511-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="18511-104">Bu dosyalar için kullanılan şema, aşağıdaki XSD tanımlar.</span><span class="sxs-lookup"><span data-stu-id="18511-104">The following XSD defines the schema used for these files.</span></span>
