...
---
# <a name="resource-mapping-schema"></a>Kaynak Eşleme Şeması

Management OData IIS uzantısı, kaynak eşlemesi tanımlamak için XML dosyalarını kullanır. Bu dosyalar için kullanılan şema, aşağıdaki XSD tanımlar.

## <a name="resource-mapping-file-xsd"></a>Kaynak eşleme dosyası XSD

Aşağıdaki XSD şema Management OData IIS uzantısı kaynak eşleme dosyalarının tanımlar.
