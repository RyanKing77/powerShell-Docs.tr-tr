...
ms.locfileid: "62080569"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="61d79-102">Kaynak Eşleme Şeması</span><span class="sxs-lookup"><span data-stu-id="61d79-102">Resource Mapping Schema</span></span>

<span data-ttu-id="61d79-103">Management OData IIS uzantısı, kaynak eşlemesi tanımlamak için XML dosyalarını kullanır.</span><span class="sxs-lookup"><span data-stu-id="61d79-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="61d79-104">Bu dosyalar için kullanılan şema, aşağıdaki XSD tanımlar.</span><span class="sxs-lookup"><span data-stu-id="61d79-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="61d79-105">Kaynak eşleme dosyası XSD</span><span class="sxs-lookup"><span data-stu-id="61d79-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="61d79-106">Aşağıdaki XSD şema Management OData IIS uzantısı kaynak eşleme dosyalarının tanımlar.</span><span class="sxs-lookup"><span data-stu-id="61d79-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
