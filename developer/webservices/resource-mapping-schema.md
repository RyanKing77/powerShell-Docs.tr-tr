---
title: Şema eşleme kaynak | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56851502"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="e9aa8-102">Kaynak Eşleme Şeması</span><span class="sxs-lookup"><span data-stu-id="e9aa8-102">Resource Mapping Schema</span></span>

<span data-ttu-id="e9aa8-103">Management OData IIS uzantısı, kaynak eşlemesi tanımlamak için XML dosyalarını kullanır.</span><span class="sxs-lookup"><span data-stu-id="e9aa8-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="e9aa8-104">Bu dosyalar için kullanılan şema, aşağıdaki XSD tanımlar.</span><span class="sxs-lookup"><span data-stu-id="e9aa8-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="e9aa8-105">Kaynak eşleme dosyası XSD</span><span class="sxs-lookup"><span data-stu-id="e9aa8-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="e9aa8-106">Aşağıdaki XSD şema Management OData IIS uzantısı kaynak eşleme dosyalarının tanımlar.</span><span class="sxs-lookup"><span data-stu-id="e9aa8-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
